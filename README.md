...
*   **1.0 MHz Step/Dir:** Стабильная генерация импульсов на осях X/Y. Реализовано через низкоуровневый доступ к таймерам TIM1/TIM8 и регистрам GPIO BSRR (**"800 KHz Secret"**).
